...
//Acá esta implementado todo lo de la decima funcionalidad
public class Administrador extends Usuario {
    ...
    System.out.print("Administrador, ingrese su contraseña: ");
    
    // Lee la contraseña ingresada por el administrador
    ...
    if (contraseñaIngresada.equals(this.getContraseña())) {
        ...
        do {
            ...
            // Pide al administrador que seleccione una opción
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    // Aquí puedes agregar lógica para definir la contraseña y el documento del nuevo usuario
                    // Por simplicidad, se creará un usuario básico
